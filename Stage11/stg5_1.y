...
Fdef : Type ID '(' ArgFuncList ')' '{' LDefblock Body '}' { checkBreak(breakstmt); $8->value=countLsym(); checkRetType($8,$1,$2); codegenrate($8,$2);}
	 ;

LDefblock : DECL LDefList ENDDECL {LargAssign();}
		  ;
